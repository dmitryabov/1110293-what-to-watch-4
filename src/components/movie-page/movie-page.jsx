...
const MoviePage = (props) => {
  const {name, src, poster, genre, released} = props.movie;
  const {onMovieImgClick, onMovieTitleClick, activeTab, clickOnTab} = props;
        ...
        <div className="movie-card__wrap movie-card__translate-top">
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              ...
              {activeTab === movieTabType.details && <MoviePageDetails movies={props.movie}/>}
              {activeTab === movieTabType.overview && <MoviePageOverview movies={props.movie}/>}
              {activeTab === movieTabType.reviews && <MoviePageReviews comments={props.comments}/>}
            </div>
          </div>
        </div>
      </section>
